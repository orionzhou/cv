...
table_data <- read_xlsx('cv.xlsx', sheet='positionsC', na = "NA") %>% 
  mutate_all(fill_nas) %>% 
...
print_section(table_data, 'education')
```

工作经历 {data-icon=laptop}
--------------------------------------------------------------------------------

```{r, results='asis', echo = FALSE}
print_section(table_data, 'research_positions')
```
...
- 中国农业科学院杰出青年英才计划（2024.01-2028.12）
- 国家重点研发计划课题主持（2023YFF1000104）（2023.12-2028.12）
- 国家基金委优秀青年科学基金（海外）（2023.01-2025.12）
- 科技创新2030生物育种重大专项子课题（2023ZD04076）（2023.12-2025.12）
- 人社部高层次留学人才回国资助（2022.01-2023.12）
...
```{r}
print_section(table_data, 'academic_articles0')
```
...
```{r}
print_section(table_data, 'academic_articles')
```
