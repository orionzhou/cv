...
position_data <- read_xlsx('yz.xlsx', sheet='main', na = "NA") %>% 
  mutate_all(fill_nas) %>% 
...
cat(sanitize_links("<font size=3>籍贯：浙江丽水<br />年龄：1992.10.26<br />政治面貌：群众</font><br /><br />"))

intro_text <- glue("<font size=2>双语社会工作者, 能够独立根据工作要求，将方西社会工作理念 和技巧本土化。有着较强的人际交往能力与沟通能力,可以进行简单的商业洽谈, 能够独立代表公司完成资方或者合作方的商业 沟通和商务合作, 精通中英文听说读写。寻求一个能够充分展示我的专业技能，运用海外求学经历和过往工作经验的岗位，对社会工作、公益事业、社区工作、群众工作和政府事务充满热情。同时也对社会主义新时代的商业运营模式和商务洽谈的新思路和新方式充满了好奇并做好了充分的工作准备。本人对祖国的文化和历史有着深厚的人文情怀，对党和政府的执政和政策落实怀抱高度的敬畏和感恩。</font>")
...
教育背景 {data-concise=true data-icon=graduation-cap data-concise=true}
--------------------------------------------------------------------------------
...
工作经历 {data-concise=true data-icon=briefcase}
--------------------------------------------------------------------------------
...
实习/志愿服务经历 {data-concise=true data-icon=hospital}
--------------------------------------------------------------------------------
...
领导经历 {data-concise=true data-icon=users}
--------------------------------------------------------------------------------
...
获奖情况 {data-concise=true data-icon=trophy}
--------------------------------------------------------------------------------
