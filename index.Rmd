...
```{r, results='asis'}
intro_text <- glue("<font size=2.5>Investigator at Institute of Crop Sciences, Chinese Academy of Agricultural Sciences (CAAS). Using a combination of classical genetics, comparative genomics and multi-omics approaches, I work to understand the regulatory mechanism of gene expression during plant development and under stress conditions, identify key cis-regulatory elements and transcription factors for crop improvement. My research interests also include constructing plant gene regulatory networks, training machine learning models to predict temporal/spatial gene expression patterns, as well as understanding the molecular mechanism of heterosis.</font>")
