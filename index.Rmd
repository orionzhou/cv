...
- <i class="fa fa-phone"></i> (+1) 6125323168
...
```{r, results='asis'}
intro_text <- glue("Post Doctoral Associate at [University of Minnesota](https://maizeumn.github.io) working on maize genomics, gene regulation, heterosis and stress response.")

cat(sanitize_links(intro_text))
```

I am broadly interested in genomics, computational biology, data integration and visualization.
