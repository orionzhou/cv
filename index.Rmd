...
```{r, results='asis'}
intro_text <- glue("Post Doctoral Associate at [University of Minnesota](https://maizeumn.github.io) working on maize genomics and epi-genomics, gene regulatory networks, heterosis and abiotic stress response.")

cat(sanitize_links(intro_text))
```

I am broadly interested in plant genomics and epi-genomics, functional genomics and predictive biology.
